...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
            ...
            translate('LBL_STACKIMAGINE_EMAIL_WRITER', 'Administration') . ': ' . translate('LBL_STACKIMAGINE_EMAIL_WRITER_LICENSE_TITLE', 'Administration'),
        );
    }
    ...
    public function display()
    {
        ...
        $key = si_Email_WriterOutfittersLicense::getKey($currentModule);
