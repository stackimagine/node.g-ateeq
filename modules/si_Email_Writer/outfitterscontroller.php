...
require_once('modules/' . $currentModule . '/license/si_Email_WriterOutfittersLicense.php');

if ($_REQUEST['method'] == 'validate') {
    si_Email_WriterOutfittersLicense::validate();
} else if ($_REQUEST['method'] == 'isValid') {
    echo si_Email_WriterOutfittersLicense::isValid("si_Email_Writer");
} else if ($_REQUEST['method'] == 'change') {
    si_Email_WriterOutfittersLicense::change();
} else if ($_REQUEST['method'] == 'add') {
    si_Email_WriterOutfittersLicense::add();
    ...
    $validate_license = si_Email_WriterOutfittersLicense::isValid($currentModule, $user_id, true);
    ...
    if ($validate_license !== true) {
        ...
        $validated = si_Email_WriterOutfittersLicense::doValidate($currentModule);
